...
For installing the compiler and core packages, start with the [Installation Guide](../get-started/installation-guide#windows). This page focuses on day-to-day development on Windows.
