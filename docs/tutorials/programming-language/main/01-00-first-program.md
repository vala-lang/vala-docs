...
care of by the [**GObject**](https://valadoc.org/gobject-2.0/index.htm) library, but details of this are not important
for general usage.

What is important to note is that this class is specifically described
as being a subclass of [**GLib.Object**](https://valadoc.org/gobject-2.0/GLib.Object.html). This is because Vala allows other
