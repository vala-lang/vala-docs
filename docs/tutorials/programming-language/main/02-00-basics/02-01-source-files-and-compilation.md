...
structure a project in Vala is the [Vala project](https://gitlab.gnome.org/GNOME/vala) itself.
...
works similarly to how Java source code is compiled. 
...
This produces a binary with the name `compiler` that links with the
