...
instances of it are also instances of `Object`, and contain all the members of that
...
glib/gobject, you will recognize this as being equivalent to defining
...
The constructor initializes new instances of a class. It has the same
