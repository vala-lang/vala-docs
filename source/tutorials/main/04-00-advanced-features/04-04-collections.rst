...
`Gee </developer-guides/libgee>`_ is a library of collection classes, written in Vala.  The classes should all be familiar to users of libraries such as Java's Foundation Classes. Gee consists of a set of interfaces and various types that implement these in different ways.
...
`Gee API documentation <http://valadoc.org/gee-0.8/index.htm>`_, `Gee Examples </developer-guides/gee-examples>`_.
